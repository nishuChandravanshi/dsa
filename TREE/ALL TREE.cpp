...
BT-
    ...
    as search is as quick as in a sorted array and insertion or deletion operation are as fast as in linked list.

*/

//1. kth smallest in BT
...
//return inorder(root,k,res); ->res =-1;
